...
<div class="container">
		<div class="container">
			<div class="col-sm-12 col-xm-12 col-md-12 col-lg-12"><!-- col-sm-10 -->
				<div style="border-bottom: 1px solid #eee; margin-top: -32px;">
					<ul class="nav navbar-nav navbar-left">		
						...
						<li><a href="AccountSet.jsp">修改信息</a></li>
					</ul>
				</div>
			</div><!-- col-sm-10 -->
<div class="col-sm-12 col-xm-12 col-md-12 col-lg-12"><!-- col-sm-10 -->
				...
				<ul class="nav navbar-nav navbar-left" style="margin-left: 60px;">
                     <div class="container style="color:#f8f0e5">
							<div class="col-sm-12 col-xm-12 col-md-12 col-lg-12">
								<form action="AccountSetServlet" method="post" enctype="multipart/form-data" onsubmit="return validate()()">
										...
										<ul class="dian">
											<li>
												...
												<%
												   ...
												   Entity entity=d.getPersonlMessage(accountName);	
												%>	
												<img style="border-radius:25px;border: none;margin-left:5px" src="<%=entity.getFileName()%>" />
												<br>
												<br>
											...
											<li>
												<p>
													姓名:<input type="text" name="myName" placeholder="输入姓名"
														required oninvalid="this.setCustomValidity("
														姓名不为空") oninput="setCustomValidity('')" value="<%=entity.getUserName()%>">
												</p>
											</li>
											<li>
												<p style="margin-left: -120px">
													性别:<input style="width: 20px; hight: 10px" type="radio"
														name="sex" checked="checked" value="<%=entity.getSex()%>" />男<input
														style="width: 20px; hight: 10px" type="radio"
														name="gender" value="<%=entity.getSex()%>">女
												</p>
											</li>
											<br>
											<li>
												...
												<p>
													邮箱:<input name="email" id="UserName" type="text"
														placeholder="输入邮箱"
														pattern="^[\w._]+@([qQ][qQ]|[gG][mM][aA][iI][lL]|163)\.[cC][oO][mM](\r\n|\r|\n)?$"
														required oninvalid="this.setCustomValidity('邮箱不对哦');"
														oninput="setCustomValidity('')" value="<%=entity.getEmail()%>">
												</p>
											</li>
											<li>
												<p>
													地址:<input name="address" id="Repassword" type="test"
														placeholder="地址" required
														oninvalid="this.setCustomValidity('
														地址不为空')" oninput="setCustomValidity('')" value="<%=entity.getAdderss()%>">
												</p>
											</li>
											<li>
												<p>
													电话:<input name="phoneNumber" id="Repassword" type="test"
														placeholder="电话"
														required oninvalid="this.setCustomValidity('电话不对哦!')" oninput="setCustomValidity('')"
														value="<%=entity.getPhoneNumber()%>" />
												</p>
											</li>
											<input value="确定" type="submit" class="form-login " id="width" />&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
