...
<%
           ...
           int totalNumber=dao.getTotalFeedBackNumber();
           ArrayList<Recipe> list=dao.getTotalFeedBackMessage(); 
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td> <a title="删除" href="DeleteFeedBackServelet?feedBackId=<%=r.getAllID() %>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
