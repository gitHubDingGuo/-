...
<body style="background: #FFFFFF; height: 2000px;" onload="startTime()">
			...
			<div class="col-sm-12 col-xm-12 col-md-12 col-lg-12">
				...
				<div style="border-bottom: 1px solid #eee; margin-top: -32px;">
					<ul class="nav navbar-nav navbar-left">
						<li class="active"><a href="ShowCookBookServlet">查看菜谱</a></li>
						<li>
							<p></p>
						</li>
					...
					<ul class="nav navbar-nav navbar-left" style="margin-left: 60px;">
						...
						<div class="container style="color:#f8f0e5">
							<div class="col-sm-12 col-xm-12 col-md-12 col-lg-12">
								...
								<table border="0.5" cellspacing="4" cellpadding="10"
									bgcolor="green" style="margin-left: -80px">
									<c:forEach var="all" items="${requestScope.recipes}"
										varStatus="i" step="1">
										<tr>
										  
											<td><img style="width: 200px; height: 200px"
												src=" ${all.pictureName}"  /><br> <br> <br> <br></td>
											<td colspan="3" style="width: 800px"><h2
													style="font-size: 20px; line-height: 130%; color: #999">
													<p>${all.menuName}
												</h2> <br>
												<p style="font-size: 14px; line-height: 130%; color: #999">来源:${all.accountName}</p>
												<br>
												<p style="font-size: 14px; line-height: 130%; color: #999">主料:${all.mainIngredient}</p></td>
	
											<td><a
												href="DeleteCookBookServelet?pictureNames=${all.pictureName}">移除</a></td>
										</tr>
   ...
   <img src="D:/JavaEE/Java-Web/ending/WebContent/recipeImg/1547114118213.jpg" />
