	...
	<body style="background: #EEEEEE;height: 2000px;" onload="startTime()">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img  style="width: 1200px;height: 410px;" src="http://img3.imgtn.bdimg.com/it/u=3937119920,4221185309&fm=26&gp=0.jpg" alt="...">
		...
		<!-- 	 <div class="col-sm-4">
			...
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
				<img style="width: 360px;height: 240px" src="allImg/0.png" class="img-responsive">
			<p>
				<a href="CheckPicture.jsp?recipeId1=0"><button class="btn btn-primary">查看详情</button></a>
				<span>干贝菜汤</span>
			...
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
				<img style="width: 360px;height: 240px" src="allImg/1.png" class="img-responsive">
			<p>
				<a href="CheckPicture.jsp?recipeId1=1"><button class="btn btn-primary">查看详情</button></a>
				<span>香煎面包</span>
			</p>
			</div>
			
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
			<img style="width: 360px;height: 240px" src="allImg/2.png" class="img-responsive">
			<p>
				<a href="CheckPicture.jsp?recipeId1=2"><button class="btn btn-primary">查看详情</button></a>
				<span>香菜鱼饼</span>
			 ...
			 <div class="row row2" >
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
				<img src="allImg/3.png" class="img-responsive" >
			<p>
				<a href="CheckPicture.jsp?recipeId1=3"><button class="btn btn-primary">查看详情</button></a>
				<span>五味杂陈</span>
			</p>
			</div>
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
				<img src="allImg/4.png" class="img-responsive">
			<p>
				<a href="CheckPicture.jsp?recipeId1=4"><button class="btn btn-primary">查看详情</button></a>
				<span>酸辣黄鱼</span>
			</p>
			</div>
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
				<img style="width: 360px;height: 240px" src="allImg/5.png" class="img-responsive">
			<p>
				<a href="CheckPicture.jsp?recipeId1=5"><button class="btn btn-primary">查看详情</button></a>
				<span>五香熏鱼</span>
			</p>
			</div>
		</div> 
			 ...
			 <div class="row row3" >
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
				<img src="allImg/6.png" class="img-responsive">
			<p>
				<a href="CheckPicture.jsp?recipeId1=6"><button class="btn btn-primary">查看详情</button></a>
				<span>御泉柠檬</span>
			</p>
			</div>
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
				<img src="allImg/7.png" class="img-responsive">
			<p>
				<a href="CheckPicture.jsp?recipeId1=7"><button class="btn btn-primary">查看详情</button></a>
				<span >樱桃橙檬</span>
			</p>
			</div>
			<div class="col-sm-4 col-xm-4 col-md-4 col-lg-4">
				<img src="allImg/8.png" class="img-responsive">
			<p>
				<a href="CheckPicture.jsp?recipeId1=8"><button class="btn btn-primary">查看详情</button></a>
				<span >果物纷纷</span>
			</p>
			</div>
		</div> 
