...
<%
      ...
      int totalAdminNumber=adminDao.getTotalAdminNumber();
      int totalUserNumber=adminDao.getTotalUserNumber();
%>
<div class="page-container">

	<p>当前用户在线人数:${applicationScope.online}</p>
