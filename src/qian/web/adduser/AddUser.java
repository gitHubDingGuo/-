	    ...
	    if(buffer.toString().equals("")) {
	    	 ...
	    	 try {
				if(dao.isExsit(name)==true) {
					...
					RequestDispatcher aDispatcher=request.getRequestDispatcher("AddUser.jsp");
			        aDispatcher.forward(request, response);
				 }else {
					 entity=new Entity();
					 entity.setName(name);
					 ...
					 RequestDispatcher a=request.getRequestDispatcher("main.jsp");
